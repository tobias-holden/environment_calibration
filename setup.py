...
authors = [
    ...
    ('Anne Stahlfeld', 'anne.stahlfeld@northwestern.edu')
    ('Ricky Richter', 'richard-richter@northwestern.edu')
]

setuptools.setup(
    name="environmental_calibration",
    version="1.0.0",
    author=[author[0] for author in authors],
    author_email=[author[1] for author in authors],
    description="malaria-model_validation adapted for environmental calibration package",
    install_requires=requirements,
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/RickyRichterNU/environmental_calibration",
    project_urls={
        "Bug Tracker": "https://github.com/RickyRichterNU/environmental_calibration/issues",
    },
    classifiers=[
